...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=11586134&assignment_repo_type=AssignmentRepo)
# ProjÁgil - 2023
...
1. **Jogos da plataforma Xbox One**:
   ...
   - **Resultado**<br>
      ...
      The Technomancer<br>
      Dead Island Definitive Collection<br>
...
2. **Jogos de Ação após 2010**:
   ...
   - **Query**:
     ```sql
      SELECT Name FROM vgsales_pbi WHERE Genre == 'Action' AND Year > 2010
     ```
   - **Resultado**<br>
    Brothers Conflict: Precious Baby<br>
    Lego Star Wars: The Force Awakens<br>
    Gundam Breaker 3<br>
    Taiko no Tatsujin: Don Don! Mystery Adventure<br>
    ReCore<br>
...
3. **Jogos mais recentes**:
   ...
   - **Query**:
     ```sql
      SELECT Name FROM vgsales_pbi ORDER BY Year DESC LIMIT 5
     ```
   - **Resultado**<br>
   Imagine: Makeup Artist<br>
   Phantasy Star Online 2 Episode 4: Deluxe Package<br>
   Brothers Conflict: Precious Baby<br>
   Phantasy Star Online 2 Episode 4: Deluxe Package<br>
   Hyakka Hyakurou: Sengoku Ninpoujou<br>
...
5. **Jogos de Aventura com mais vendas na América do Norte**:
   ...
   - **Query**:
     ```sql
      SELECT Name FROM vgsales_pbi ORDER BY Year LIMIT 5
     ```
   - **Resultado**<br>
   Bridge<br>
   Freeway<br>
...
6. **Jogos de RPG ou Estratégia lançados após 2005**:
   ...
   - **Query**:
     ```sql
      SELECT Name FROM vgsales_pbi WHERE (Genre == 'Role-Playing' or Genre == 'Strategy') and Year > 2005
     ```
   - **Resultado**<br>
   Phantasy Star Online 2 Episode 4: Deluxe Package<br>
   Phantasy Star Online 2 Episode 4: Deluxe Package<br>
